  ...
  <body id="home">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-info fixed-top">
      <div class="container-fluid">
        <a class="navbar-brand" href="#">Silvi</a>
    ...
    <section class="jumbotron text-center">
      <img src="<?= baseurl;?>/asset/img/<?= $pro['foto'];?>" alt="" width="250" height="250" class="rounded-circle img-thumbnail"./>
...
<section id="project">
  <div class="Container">
    ...
    <div class="row justify-content-center">
      ...
      <div class="col-md-4 mb-3">
        <div class="card">
          <img src="<?= baseurl;?>/asset/img/<?= $pro['foto'];?>" class="card-img-top" alt="foto_project">
          <div class="card-body">
            <h3><?= $pro['nama_p'];?></h3>
 ...
 <!-- Contact -->
    <section id="contact">
      <div class="container">
        ...
        <div class="row justify-content-center">
          <div class="col-md-6">
            <form action="<?= baseurl;?>/Portofoio/pesan" method="POST">
              <div class="mb-3">
   ...
   <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#ccccff" fill-opacity="1" d="M0,0L48,32C96,64,192,128,288,170.7C384,213,480,235,576,218.7C672,203,768,149,864,122.7C960,96,1056,96,1152,122.7C1248,149,1344,203,1392,229.3L1440,256L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path></svg>
    ...
    <footer class= "footer text-white text-center p-3">
      <p>Created With <i class="bi bi-heart-fill text-danger"></i> by <a href="https://www.instagram.com/Silvisw_30" Class="text-white fw-bold">Silvisw_30</p>
    </footer>
    <!-- Akhir Footer -->
    <!-- JavaScript-->
